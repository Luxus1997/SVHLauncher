package com.haoyue.svhlauncher.camera;
...
import com.haoyue.svhlauncher.camera.base.AspectRatio;
import com.haoyue.svhlauncher.camera.base.Constants;
import com.haoyue.svhlauncher.camera.base.Size;
import com.haoyue.svhlauncher.camera.base.SizeMap;
import com.haoyue.svhlauncher.utils.FileUtils;
    ...
    private void savePictureToSDCard(byte[] data) {
        ...
        if (FileUtils.checkSDCard()) {
            if (mPictureSaveDir == null) {
                ...
                pictureFile = FileUtils.getMediaFile(mPictureSaveDir, FileUtils.MEDIA_TYPE_IMAGE);
            }
            if (pictureFile == null) {
