...
public class HTBodyResultTwoArms extends HTBodyResult {
    ...
    private native int native_getbodyfat(int htTwoArmsImpedance, boolean b);
    ...
    private native double native_z_twoarms();
    ...
    public int getBodyfatWithBasicInfo(HTBodyBasicInfo htBodyBasicInfo) {
        ...
        int native_getbodyfat = native_getbodyfat(htBodyBasicInfo.htTwoArmsImpedance, true);
